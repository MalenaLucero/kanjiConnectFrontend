  ...
  filterLessons(filter: number | 'reverse' | 'all') {
    switch(filter) {
      ...
      case 2022:
        ...
        break;
      case 2023:
        this.filteredLessons = this.lessons.filter(lesson => lesson.date.toString().substring(0, 4) === '2023');
        this.filteredYear = 2023;
        break;
      case 2024:
      ...
      case 2025:
        ...
        break;
      case 2026:
        this.filteredLessons = this.lessons.filter(lesson => lesson.date.toString().substring(0, 4) === '2026');
        this.filteredYear = 2026;
        break;
      case 'reverse':
